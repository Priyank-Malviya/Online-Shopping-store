...
public class DatabaseConnection {
    ...
    public static Connection getConnection() {
        try {
            ...
            connection = DriverManager.getConnection("jdbc:sqlserver://resume-project.database.windows.net:1433;database=OnlineShopping;user=Priyank@resume-project;password=Login@72925;encrypt=true;trustServerCertificate=true;hostNameInCertificate=*.database.windows.net;loginTimeout=30;");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return (connection);
